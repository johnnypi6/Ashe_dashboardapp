...
insert  into `device`(`Id`,`UserId`,`LocationId`,`IMEI`,`SIMCard`,`Type`,`Vehicle`,`Status`) values (1,3,1,'373782822','383892929',1,'Vehicle1',1);
...
insert  into `sensor`(`Id`,`DeviceId`,`Type`,`SerialNumber`,`HighThreshold`,`LowThreshold`,`RelayOperation`,`Status`) values (1,1,1,'324324324','10.5','1.5',0,0),(2,1,2,'345987656','6.0','0.5',0,0),(3,1,3,'569876545','7.8','2.5',0,0),(4,1,4,'906864534','6.3','5.2',0,0),(5,1,5,'863543234','7.0','2.5',0,0),(6,1,6,'214667866','3.5','1.0',0,0);
